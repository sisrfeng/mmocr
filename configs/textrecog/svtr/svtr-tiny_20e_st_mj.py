...
#              ]
#
# test_list = [_base_.cute80_textrecog_test,
...
train_dataloader = dict(batch_size=1,
                        ...
                        dataset=dict(type='ConcatDataset', datasets=train_list, pipeline=_base_.train_pipeline),
                       )
...
val_dataloader = dict(batch_size=1,
                      ...
                      dataset=dict(type='ConcatDataset', datasets=test_list, pipeline=_base_.test_pipeline),
                     )
